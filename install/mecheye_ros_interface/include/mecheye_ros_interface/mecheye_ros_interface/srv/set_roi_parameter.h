...
#ifndef MECHEYE_ROS_INTERFACE__SRV__SET_ROI_PARAMETER_H_
#define MECHEYE_ROS_INTERFACE__SRV__SET_ROI_PARAMETER_H_
...
#endif  // MECHEYE_ROS_INTERFACE__SRV__SET_ROI_PARAMETER_H_
