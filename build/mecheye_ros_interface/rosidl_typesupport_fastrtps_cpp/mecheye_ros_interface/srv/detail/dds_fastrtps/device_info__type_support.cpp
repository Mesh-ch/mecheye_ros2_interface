...
#include "mecheye_ros_interface/srv/detail/device_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mecheye_ros_interface::srv::DeviceInfo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecheye_ros_interface::srv::DeviceInfo_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mecheye_ros_interface::srv::DeviceInfo_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecheye_ros_interface
max_serialized_size_key_DeviceInfo_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mecheye_ros_interface::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mecheye_ros_interface::srv::DeviceInfo_Request *>(
    untyped_ros_message);
...
{
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecheye_ros_interface, srv, DeviceInfo_Request)() {
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecheye_ros_interface
cdr_serialize(
  const mecheye_ros_interface::srv::DeviceInfo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: model
  ...
  // Member: subnet_mask
  cdr << ros_message.subnet_mask;

  // Member: ip_assignment_method
  cdr << ros_message.ip_assignment_method;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecheye_ros_interface::srv::DeviceInfo_Response & ros_message)
{
  // Member: model
  cdr >> ros_message.model;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mecheye_ros_interface::srv::DeviceInfo_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecheye_ros_interface
max_serialized_size_key_DeviceInfo_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mecheye_ros_interface::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mecheye_ros_interface::srv::DeviceInfo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecheye_ros_interface, srv, DeviceInfo_Response)() {
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Response__handle;
}
...
// functions for mecheye_ros_interface::srv::DeviceInfo_Request already declared above

// functions for mecheye_ros_interface::srv::DeviceInfo_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecheye_ros_interface
cdr_serialize(
  const mecheye_ros_interface::srv::DeviceInfo_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mecheye_ros_interface::srv::DeviceInfo_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecheye_ros_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_DeviceInfo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecheye_ros_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_DeviceInfo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mecheye_ros_interface::srv::DeviceInfo_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mecheye_ros_interface
max_serialized_size_key_DeviceInfo_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecheye_ros_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_key_DeviceInfo_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mecheye_ros_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_key_DeviceInfo_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mecheye_ros_interface::srv::DeviceInfo_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mecheye_ros_interface::srv::DeviceInfo_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecheye_ros_interface, srv, DeviceInfo_Event)() {
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo_Event__handle;
}
...
static const rosidl_service_type_support_t _DeviceInfo__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecheye_ros_interface::srv::DeviceInfo_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecheye_ros_interface::srv::DeviceInfo_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mecheye_ros_interface::srv::DeviceInfo_Event>(),
...
{
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecheye_ros_interface, srv, DeviceInfo)() {
  return &mecheye_ros_interface::srv::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
