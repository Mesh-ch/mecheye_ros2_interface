...
#ifndef MECHEYE_ROS_INTERFACE__SRV__DELETE_USER_SET_H_
#define MECHEYE_ROS_INTERFACE__SRV__DELETE_USER_SET_H_
...
#endif  // MECHEYE_ROS_INTERFACE__SRV__DELETE_USER_SET_H_
