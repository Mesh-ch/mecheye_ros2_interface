...
// IWYU pragma: private, include "mecheye_ros_interface/srv/capture_textured_point_cloud.h"


#ifndef MECHEYE_ROS_INTERFACE__SRV__DETAIL__CAPTURE_TEXTURED_POINT_CLOUD__FUNCTIONS_H_
#define MECHEYE_ROS_INTERFACE__SRV__DETAIL__CAPTURE_TEXTURED_POINT_CLOUD__FUNCTIONS_H_
...
/// Initialize srv/CaptureTexturedPointCloud message.
/**
 ...
 * )) before or use
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__create()
...
/// Finalize srv/CaptureTexturedPointCloud message.
/**
...
/// Create srv/CaptureTexturedPointCloud message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__init().
...
/// Destroy srv/CaptureTexturedPointCloud message.
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__fini()
...
/// Check for srv/CaptureTexturedPointCloud message equality.
/**
...
/// Copy a srv/CaptureTexturedPointCloud message.
/**
...
/// Initialize array of srv/CaptureTexturedPointCloud messages.
/**
...
/// Finalize array of srv/CaptureTexturedPointCloud messages.
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__fini()
...
/// Create array of srv/CaptureTexturedPointCloud messages.
/**
 * It allocates the memory for the array and calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CaptureTexturedPointCloud messages.
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CaptureTexturedPointCloud message array equality.
/**
...
/// Copy an array of srv/CaptureTexturedPointCloud messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It allocates the memory for the array and calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It allocates the memory for the array and calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mecheye_ros_interface
...
/**
 * It calls
 * mecheye_ros_interface__srv__CaptureTexturedPointCloud_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MECHEYE_ROS_INTERFACE__SRV__DETAIL__CAPTURE_TEXTURED_POINT_CLOUD__FUNCTIONS_H_
